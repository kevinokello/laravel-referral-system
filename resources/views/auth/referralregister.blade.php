                    ...
                    <div class="card my-3">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('user.register') }}" method="post" class="my-2">
                                ...
                                <div class="form-group">
                                    <input type="text" style="pointer-events: none; background: lightgray" id="referral_code"value="{{ $referral_value }}" name="referral_code" class="form-control" placeholder="Referral Code (Optional)" value="{{ old('email') }}">
                                </div>
                                <div class="form-group">
